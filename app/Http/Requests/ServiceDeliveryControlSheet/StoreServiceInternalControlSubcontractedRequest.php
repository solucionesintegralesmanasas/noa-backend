...
class StoreServiceInternalControlSubcontractedRequest extends FormRequest
{
    ...
    {
        return [
            'vehicle_class_uuid' => ['required', 'uuid', 'exists:vehicle_classes,uuid'],
            ...
            'driver_name_and_surname' => ['required', 'string', 'max:255'],
