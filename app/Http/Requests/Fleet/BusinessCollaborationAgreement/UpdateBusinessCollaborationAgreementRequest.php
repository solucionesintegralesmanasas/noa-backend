...
class UpdateBusinessCollaborationAgreementRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'resolution_number' => 'sometimes|nullable|string|max:50',
            'agreement_internal_id' => 'sometimes|nullable|string|max:50',
            'contracting_entity_nit' => 'sometimes|required|string|max:20',
            'contracting_entity_name' => 'sometimes|required|string|max:255',
            'effective_date' => 'sometimes|required|date',
            'expiry_date' => 'sometimes|required|date',
            'rep_name' => 'sometimes|required|string|max:150',
            'rep_document_id' => 'sometimes|required|string|max:20',
            'transport_modality' => 'sometimes|required|in:CARGA,ESPECIAL,PASAJEROS,MIXTO',
