...
/**
 * Request para validar la creación de una Empresa.
 */
class StoreCompanyRequest extends FormRequest
{
    ...
    {
        return [
            'person_type' => 'required|in:PERSONA NATURAL,PERSONA JURIDICA',
            'type_of_company' => 'required|in:PUBLICO,PRIVADO',
            ...
            'tax_regime_uuid' => 'required|uuid|exists:tax_regimes,uuid',
            ...
            'legal_representative_last_name' => 'required|string|max:255',
            'legal_representative_document_type' => 'required|string|max:20',
            'legal_representative_document_number' => 'required|string|max:20',
