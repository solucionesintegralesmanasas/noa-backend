...
/**
 * Petición de validación para la actualización de un DirectorTerritorial existente.
 *
 ...
 * @created  2026-05-29
 */
class UpdateTerritorialDirectorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'territorial_director' => 'nullable|string|max:255',
