...
class StoreSystemConfigurationRequest extends FormRequest
{
    ...
    {
        return [
            'company_uuid' => 'required|uuid|exists:companies,uuid|unique:system_configuration,company_uuid',
            'fuec_require_daily_inspections' => 'nullable|boolean',
            'fuec_require_social_security' => 'nullable|boolean',
            ...
            'payment_cutoff_day' => 'required|integer|min:1|max:31',
            'document_alert_days' => 'nullable|integer|min:0|max:255',
            'license_alert_days' => 'nullable|integer|min:0|max:255',
            'operation_card_alert_days' => 'nullable|integer|min:0|max:255',
            'soat_alert_days' => 'nullable|integer|min:0|max:255',
            'rtm_alert_days' => 'nullable|integer|min:0|max:255',
    ...
    public function messages(): array
    {
        return [
            ...
            'payment_cutoff_day.required' => 'El día de corte es obligatorio.',
