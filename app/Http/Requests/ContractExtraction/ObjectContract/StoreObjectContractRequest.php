...
/**
 * Solicitud de validación para la creación de un nuevo Objeto de Contrato.
 */
class StoreObjectContractRequest extends FormRequest
{
    ...
    {
        return [
            'uuid' => 'UUID del objeto de contrato',
