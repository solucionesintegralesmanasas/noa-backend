...
class ServiceDeliveryControlSheetController extends Controller
{
    ...
    #[OA\Get(
        path: '/api/v1/service-delivery-control-sheets',
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            $data = $this->serviceDeliveryControlSheetService->getAllServiceDeliveryControlSheetsWithPagination($perPage, $page, $search, $companyUuid);
    ...
    #[OA\Get(
        path: '/api/v1/service-delivery-control-sheets/list',
    ...
    #[OA\Get(
        path: '/api/v1/service-delivery-control-sheets/{uuid}',
    ...
    #[OA\Post(
        path: '/api/v1/service-delivery-control-sheets',
        summary: 'Crear nuevo registro de Hoja de Control de Entrega de Servicios',
    ...
    #[OA\Post(
        path: '/api/v1/service-delivery-control-sheets/{uuid}/start',
    ...
    #[OA\Post(
        path: '/api/v1/service-delivery-control-sheets/{uuid}/close',
